import HonorCard from "./HonorCard.jsx"
...
export default function Honors(){
    return (
        <div id="honors" className="mt-4 text-white" style={{
            backgroundImage: `url(${pp2})`, // Use the imported variable or provide the correct URL
